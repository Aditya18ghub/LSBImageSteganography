...
/* check the capacity weather it encoded data fits in correctly */
...
/* Encode a byte into LSB of the image data array */
Status encode_byte_to_lsb(char data, char *image_buffer);

/* Copy the remaining image bytes from src to stego image after encoding */
